...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Au Co&nbsp;&mdash;&nbsp;Vietnamese Cultural Center</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/blog/">Events Blog</a>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000">About Au Co</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/programs/">Programs</a></li>
                    

                      

                      <li><a href="http://localhost:4000/brochure/">Brochure</a></li>
                    

                      

                      <li><a href="http://localhost:4000/programs/vietnamese-language-class-registration/">Registration</a></li>
                    

                      

                      <li><a href="http://localhost:4000/directions/">Directions to Au Co</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000" title="Au Co&nbsp;&mdash;&nbsp;Vietnamese Cultural Center – Preserve - Promote - Practice">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Au Co&nbsp;&mdash;&nbsp;Vietnamese Cultural Center – Preserve - Promote - Practice">
			</a>
        ...
        <div class="row">
          ...
          <div class="small-6 medium-3 large-3 large-offset-1 columns">
              ...
              <ul class="no-bullet shadow-black">
                  ...
                  <li >
                    <a href="http://localhost:4000/contact/"  title="Contact">webmaster@aucocenter.org</a>
                  </li>
          ...
          <div class="small-6 medium-3 large-3 columns">
            ...
            <ul class="no-bullet shadow-black">
                ...
                <li >
                  <a href="http://localhost:4000/english/mission-statement/"  title="OUR MISSION">Preserve the Vietnamese Language and Culture. Programs for Youth Development.</a>
                </li>
